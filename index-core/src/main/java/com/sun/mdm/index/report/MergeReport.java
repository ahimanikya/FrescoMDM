 ...
 * @author  dcidon
 */
public class MergeReport extends MultirowReport2 {
     ...
     */
    public MergeReport(MultirowReportConfig2 config) {
        super(config);
    }
     ...
     */
    public MergeReportRow getNextReportRow() {
        return (MergeReportRow) getNextRow();
    }
