...
/**
 * The <b>SecurityException</b> class represents an exception thrown when
 * there is an error in security processing.
 * @author sdua
 */
public class SecurityException extends ProcessingException {
    /**
     * Creates a new instance of the SecurityException class without an
     * error message.
     * <p>
    ...
    /**
     * Creates a new instance of the SecurityException class with an
     * error message.
     * <p>
