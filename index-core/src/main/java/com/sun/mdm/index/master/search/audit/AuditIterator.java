...
/**
 * The <b>AuditIterator</b> class represents an iterator containing
 * the AuditDataObject objects returned by a call to
 * <b>lookupAuditLog</b>. Use indexes to page through the
 * AuditDataObject objects and to retrieve specific objects from the
 * iterator.
 */
public class AuditIterator extends PageIteratorWrapper
    implements java.io.Serializable {
    /**
     * Creates a new instance of the AuditIterator class that maintains
    ...
    /**
     * Creates a new instance of the AuditIterator class that does not
     ...
     * @include
     */
    public AuditIterator(ArrayList fullData) {
        super(fullData);
    }

    /**
     * Retrieves an audit data object (class AuditDataObject) at
     * the specified index from the AuditIterator object.
     * <p>
     * @param index The row to retrieve.
     * @return <CODE>AuditDataObject</CODE> - An audit data object.
    ...
    public AuditDataObject absolute(int index)
        ...
        return (AuditDataObject) getGenericIterator().absolute(index);
    }

    /**
     * Retrieves a series of rows from an AuditIterator object, beginning
     * with the row at the specified index and continuing through the
     * specified number of rows.
     * <p>
     * @param index The first row to retrieve.
     * @param count The total number of rows to retrieve.
     * @return <CODE>AuditDataObject[]</CODE> - An array of audit data
     * objects.
     * @exception PageException Thrown if an error occurs while
     ...
     * @include
     */
    public AuditDataObject[] absolute(int index, int count)
        throws PageException, RemoteException {
     ...
     * @include
     */
    public AuditDataObject first() throws PageException, RemoteException {
        return (AuditDataObject) getGenericIterator().first();
    }
   ...
   /**
     * Retrieves the next row from an AuditIterator object. If
     * the current index is 4, this method returns the row at index=4.
     * <p>
     * <DL><DT><B>Parameters:</B><DD>None.</DL>
     * @return <CODE>AuditDataObject</CODE> - An audit data
     * object.
     ...
     * @include
     */
    public AuditDataObject next() throws RemoteException, PageException {
        return (AuditDataObject) getGenericIterator().next();
    }
    ...
    /**
     * Retrieves the previous row from an AuditIterator object. If
     * the current index is 5, this method returns the row at index=4
     * and leaves the position at index=4.
     * <p>
     * <DL><DT><B>Parameters:</B><DD>None.</DL>
     * @return <CODE>AuditDataObject</CODE> - An audit data
     * object.
     ...
     * @include
     */
    public AuditDataObject prev() throws PageException, RemoteException {
        return (AuditDataObject) getGenericIterator().prev();
    }
   ...
   /**
     ...
     * <p>
     * @param count The total number of rows to retrieve.
     * @return <CODE>AuditDataObject[]</CODE> - An array of
     * audit data objects.
     * @exception PageException Thrown if the index is
    ...
    private AuditDataObject[] listToArray(ArrayList list) {
        Object[] objArray = list.toArray();
        int size = list.size();
        AuditDataObject[] result = new AuditDataObject[size];

        for (int i = 0; i < size; i++) {
            result[i] = (AuditDataObject) objArray[i];
        }
