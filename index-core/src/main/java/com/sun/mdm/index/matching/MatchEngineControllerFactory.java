...
public class MatchEngineControllerFactory {
     ...
     * @throws Exception
     */  
    public static MatchEngineController getInstance() throws Exception {         
     MatchEngineController matchEngineController = new MatchEngineControllerImpl();
     return matchEngineController;
    }  
}
