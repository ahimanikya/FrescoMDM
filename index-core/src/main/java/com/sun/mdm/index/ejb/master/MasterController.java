 ...
 * the Master Index Manager Service, which controls the primary functions
 * of the master index. This includes the "execute match" functions,
 * which are the primary functions used when processing records into
 * the master index database. It invokes the matching logic to determine
 * whether an incoming record is new or is an update to an existing
 * record. One of the following methods should be executed
 * when processing messages through the master index.
 * <UL>
 * <LI>executeMatch
...
public interface MasterController {
     ...
     * @include
     */
    public MergeHistoryNode getMergeHistory(String euid)
     ...
     * @include
     */
    public MatchResult executeMatchDupRecalc(SystemObject sysObj, Boolean performPessimistic)
        throws ProcessingException, UserException;
     ...
     * @include
     */
    public MatchResult executeMatchUpdateDupRecalc(SystemObject sysObj, Boolean performPessimistic)
        throws ProcessingException, UserException;
     ...
     * @include
     */
   public EnterpriseObject getEnterpriseObject(String euid, EOGetOptions options)
       throws ProcessingException, UserException;
     ...
     * @include
     */
    public void updateSystemObject(SystemObject sysobj, String revisionNumber)
            throws ProcessingException, UserException;
     ...
     * @include
     */
    public SystemObject[] lookupSystemObjects(String euid)
        throws ProcessingException, UserException;
     ...
     * @include
     */
    public SystemObject[] lookupSystemObjects(String euid, String status)
        throws ProcessingException, UserException;
   ...
   /**
     ...
     * @include
     */
    public UpdateResult updateEnterpriseDupRecalc(EnterpriseObject eo, Boolean performPessimistic)
        throws ProcessingException, UserException;
   ...
   /**
     ...
     * @include
     */
    public void calculatePotentialDuplicates(String euid, String transID)
         throws ProcessingException;
     ...
     * @include
     */
    public TransactionSummary lookupTransaction(String transId)
        throws ProcessingException, UserException;
   ...
   /**
     ...
     * @include
     */
    public MergeResult mergeEnterpriseObject(String fromEUID, String toEUID,
     ...
     * @include
     */
    public MergeResult mergeEnterpriseObject(String fromEUID,
                                      String toEUID,
   ...
   /**
     ...
     * @include
     */
    public MergeResult mergeEnterpriseObject(String sourceEUID,
     ...
     * was modified by another user.  In this case, the merge should not be allowed.
     * <p>
     * @param sourceEUIDs The EUIDs of the non-surviving enterprise object.
     * @param destinationEO The enterprise object that will survive
     * after the merge process.
     * @param srcRevisionNumbers The SBR revision number of the non-surviving
     * enterprise object.
     * @param destRevisionNumber The SBR revision number of the surviving
     * enterprise object.
     * @param calculateOnly A Boolean indicator of whether to commit changes
     ...
     * @include
     */
    public MergeResult[] mergeMultipleEnterpriseObjects(String[] sourceEUIDs,
                                            EnterpriseObject destinationEO,
     ...
     * @include
     */
    public MergeResult unmergeEnterpriseObject(String euid, boolean calculateOnly)
        throws ProcessingException, UserException;
    ...
    public MergeResult unmergeEnterpriseObject(String euid, String revisionNumber, boolean calculateOnly)
        throws ProcessingException, UserException;
     ...
     * @include
     */
    public void resolvePotentialDuplicate(String id, boolean autoResolve)
        throws ProcessingException, UserException;
     ...
     * @include
     */
    public void unresolvePotentialDuplicate(String id)
        throws ProcessingException, UserException;
     ...
     * @include
     */
    public SystemObjectPK[] lookupSystemObjectPKs(String euid, String status)
        throws ProcessingException, UserException;
     ...
     * @include
     */
    public SystemObjectPK[] lookupSystemObjectPKs(String sourceSystem,
     ...
     * @include
     */
    public MergeResult mergeSystemObject(String systemCode, String sourceLID,
     ...
     */
    public MergeResult mergeSystemObject(String systemCode, String sourceLID,
            String destLID, String srcRevisionNumber, String destRevisionNumber,
            boolean calculateOnly)
        throws ProcessingException, UserException;
     ...
     */
    public MergeResult mergeSystemObject(String systemCode, String sourceLID,
            String destLID, ObjectNode destImage, boolean calculateOnly)
        throws ProcessingException, UserException;
     ...
     */
    public MergeResult mergeSystemObject(String systemCode, String sourceLID,
            String destLID, ObjectNode destImage, String srcRevisionNumber,
    ...
    public MergeResult mergeSystemObject(String systemCode, String sourceLID,
            String destLID, ObjectNode destImage, String srcRevisionNumber, 
            String destRevisionNumber, boolean calculateOnly, Boolean performPessimistic)
        throws ProcessingException, UserException;
     ...
     * @include
     */
    public MergeResult unmergeSystemObject(String systemCode,
     ...
     * @include
     */
    public void activateEnterpriseObject(String euid)
        throws ProcessingException, UserException;
     ...
     * @include
     */
    public void deactivateEnterpriseObject(String euid)
        throws ProcessingException, UserException;
     ...
     * @include
     */
    public void transferSystemObject(String toEUID, SystemObjectPK systemKey)
        throws ProcessingException, UserException;
     ...
     * @include
     */
    public Integer getRevisionNumber(String euid)
            throws ProcessingException;
