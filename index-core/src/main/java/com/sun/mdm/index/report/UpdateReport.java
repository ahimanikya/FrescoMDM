 ...
 * @author  dcidon
 */
public class UpdateReport extends MultirowReport2 {
     ...
     */
    public UpdateReport(MultirowReportConfig2 config) {
        super(config);
    }
     ...
     */
    public UpdateReportRow getNextReportRow() {
        return (UpdateReportRow) getNextRow();
    }
