...
/** Activate or Deactivate an EnterpriseObject
 * @author Dan Cidon
 */
public class ChangeEnterpriseObjectStatus extends BasicHelper {
    
    /** Constructor */
    public ChangeEnterpriseObjectStatus() {       
    }
    ...
    public void run(String args[]) throws Exception {
        ...
        if (status.equals("activate")) {
            mc.activateEnterpriseObject(euid);
    ...
    public static void main(String[] args) {
        try {
            ChangeEnterpriseObjectStatus helper = new ChangeEnterpriseObjectStatus();
            helper.run(args);
