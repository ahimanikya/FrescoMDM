...
/**
 * Update policy for enterprise unmerges.
 * @author  dcidon
 */
public class EnterpriseUnmergePolicy implements UpdatePolicy {
    
    /** Creates a new instance of EnterpriseUnmergePolicy */
    public EnterpriseUnmergePolicy() {
    }
    ...
    EnterpriseObject afterImage) throws SystemObjectException, ObjectException {
        ...
        AliasHelper.markAliasesForRemoval(afterImage);
