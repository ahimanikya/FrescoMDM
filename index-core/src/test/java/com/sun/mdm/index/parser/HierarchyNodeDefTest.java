...
/**
 * HierarchyNodeDefTest
 * @author cye
 */
public class HierarchyNodeDefTest extends TestCase {
            
    public HierarchyNodeDefTest (String name) {
        super(name);
    }
    ...
    public void test001() throws Exception {    
        ...
        HierarchyNodeDef hNodeDef = new HierarchyNodeDef();
        hNodeDef.parse(node.getFirstChild());

        System.out.println(hNodeDef.toString());
    ...
    public void test005() throws Exception {         
        ...
        HierarchyNodeDef hNodeDef1 = new HierarchyNodeDef();
        hNodeDef1.parse(node.getFirstChild());

        System.out.println(hNodeDef1.toString());
