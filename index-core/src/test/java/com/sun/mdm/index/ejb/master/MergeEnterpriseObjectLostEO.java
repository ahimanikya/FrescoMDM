...
/* 
 * CreateEO 1, CreateEO 2, CreateEO 3, Create EO4
 * EUID Merge 1->2
 * EUID Merge 2->3
 * EUID Merge 4->4
 * Unmerge them & look up the transaction history
 */
 ...
 * @author Jeff Lin
 */
public class MergeEnterpriseObjectLostEO extends TestCase {
    
    /** Creates new SearchEOTester
     * @see junit.framework.TestCase#
     * @param name required by JUnit
     */
    public MergeEnterpriseObjectLostEO(String name) {
        super(name);
    }
    ...
    public void testTMTest() throws Exception {
        ...
        helper.clearDb();
        List eoList = helper.run(new String[] {"fileName=MergeEnterpriseObject_LostEO.txt", "fileType=eiEvent"});
        ...
        String[] mergeCommand3 = {"euidSource=" + euid3, "euidDest=" + euid4, "calcOnly=" + calcOnly}; 
        mr = mergeHelper.run(mergeCommand3);
        log("Merge completed.");
        
        //Test assertions by checking history 
        log("Testing assertions for third EUID Merge.");   
        assertTrue(mr != null);
        tobj = mr.getTransactionObject();
        assertTrue(tobj != null);
        transId = tobj.getTransactionNumber();
        ...
        //Unmerge the record 3 from 4
        UnmergeEnterpriseObjectHelper unmergeHelper = new UnmergeEnterpriseObjectHelper();
        log("Unmerging records 3 from 4.");
        String[] unmergeCommand = {"euid=" + euid4, "calcOnly=" + calcOnly}; 
        mr = unmergeHelper.run(unmergeCommand);
        log("Unmerge completed.");        
        
        //Test assertions
        log("Testing assertions for EUID Unmerge 3 from 4.");   
        assertTrue(mr != null);
        tobj = mr.getTransactionObject();
        assertTrue(tobj != null);
        transId = tobj.getTransactionNumber();
        ...
        String[] unmergeCommand2 = {"euid=" + euid3, "calcOnly=" + calcOnly}; 
        ...
        String[] unmergeCommand3 = {"euid=" + euid2, "calcOnly=" + calcOnly}; 
    ...
    public static void main(String[] args) {
        junit.textui.TestRunner.run(new TestSuite(MergeEnterpriseObjectLostEO.class));
    }
