...
/** Helper class for getEUID unit test
 * @author Dan Cidon
 */
public class GetEUID extends BasicHelper {
    ...
    public String run(String args[]) throws Exception {
        ...
        String euid = mc.getEUID(new SystemObjectPK(system, lid));
        return euid;
    }
