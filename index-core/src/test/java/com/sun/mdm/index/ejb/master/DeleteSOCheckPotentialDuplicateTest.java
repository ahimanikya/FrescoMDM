 ...
 */
public class DeleteSOCheckPotentialDuplicateTest extends TestCase {
    
    /** Creates new SearchEOTester
     * @see junit.framework.TestCase#
     * @param name required by JUnit
     */
    public DeleteSOCheckPotentialDuplicateTest(String name) {
        super(name);
    }
    ...
    public void testOne() throws Exception {
        ...
        executeMatchHelper.run(new String[] {"fileName=DeleteSOCheckPotentialDuplicateTest1.txt", "fileType=generic"});

        executeMatchHelper.run(new String[] {"fileName=DeleteSOCheckPotentialDuplicateTest2.txt", "fileType=generic"});
        ...
        // Now delete the SO and see the potential duplicate count again. It should be zero.
        mc.deleteSystemObject(sysObjectPK); 
    ...
    public static void main(String[] args) {
        junit.textui.TestRunner.run(new TestSuite(DeleteSOCheckPotentialDuplicateTest.class));
    }
