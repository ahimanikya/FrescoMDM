 ...
 */
public class ActivateEOCheckPotentialDuplicateTest extends TestCase {
    
    /** Creates new SearchEOTester
     * @see junit.framework.TestCase#
     * @param name required by JUnit
     */
    public ActivateEOCheckPotentialDuplicateTest(String name) {
        super(name);
    }
    ...
    public void testOne() throws Exception {
        ...
        executeMatchHelper.run(new String[] {"fileName=ActivateEOCheckPotentialDuplicateTest1.txt", "fileType=generic"});

        executeMatchHelper.run(new String[] {"fileName=ActivateEOCheckPotentialDuplicateTest2.txt", "fileType=generic"});

        MasterController mc = MCFactory.getMasterController();
        
        //Make sure there is one Potential Duplicate
        EnterpriseObject eo = mc.getEnterpriseObject(new SystemObjectPK("SiteA", "0002"));
        ...
        mc.deactivateEnterpriseObject(eo.getEUID());
    ...
    public static void main(String[] args) {
        junit.textui.TestRunner.run(new TestSuite(ActivateEOCheckPotentialDuplicateTest.class));
    }
