 ...
 * @author gzheng
 */
public class ClientRemoveAlias extends TestCase {
    /**
     * constructor
     * @param name name
     */
    public ClientRemoveAlias(String name) {
        super(name);
    }
     ...
     */
    public void testClientAddAlias() throws Exception {
        ...
        AliasObject alias = (AliasObject) EPathAPI.getFieldValue(
            "Person.Alias[@FirstName=Gary2,@LastName=Zheng2,@MiddleName=G2].*", person);
        person.deleteChild(alias);
            ...
            for (int i = 0; i < sos.size(); i++) {
                ...
                if (aliases != null) {
                    for (int j = 0; j < aliases.size(); j++) {
                        ...
                        if (a.getFirstName().equals("Gary2") && a.getLastName().equals("Zheng2")) {
