 ...
 * @author Dan Cidon
 */
public class DeleteSOAndValidateTransactionLog extends TestCase {
     ...
     */
    public DeleteSOAndValidateTransactionLog(String name) {
        super(name);
    }
    ...
    public void testDeleteSystemObject() throws Exception {
        //Insert Data.
    	// EO will contain two SystemObject. One will be deleted and TransactionLog
    	// Will be validated
    	
        CreateEnterpriseObjectHelper createHelper = new CreateEnterpriseObjectHelper();
        String[] command = {"fileName=DeleteSystemObject3.txt", "fileType=generic"};
    ...
    public static void main(String[] args) {
        junit.textui.TestRunner.run(new TestSuite(DeleteSOAndValidateTransactionLog2.class));
    }
