...
import com.sun.mdm.index.ejb.master.helper.DeactivateSystemObjectHelper;
 ...
 * @author Dan Cidon
 */
public class DeactivateSystemObject extends TestCase {
     ...
     */
    public DeactivateSystemObject(String name) {
        super(name);
    }
    ...
    public void test1() throws Exception {
        ...
        String[] command = {"fileName=DeactivateSystemObject1.txt", "fileType=generic"};
        ...
        //Deactivate SO
        DeactivateSystemObjectHelper helper = new DeactivateSystemObjectHelper();
        ...
        assertTrue(c.size() == 2);
        SystemObject so = eo2.getSystemObject(SYSTEM, LID1);
        assertTrue(so.getStatus().equals(SystemObject.STATUS_INACTIVE));        
        so = eo2.getSystemObject(SYSTEM, LID2);
    ...
    public static void main(String[] args) {
        junit.textui.TestRunner.run(new TestSuite(DeactivateSystemObject.class));
    }
