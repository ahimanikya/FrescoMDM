 ...
 * @author gzheng
 */
public class ClientEUIDMerge extends TestCase {
    /**
     * constructor
     * @param name name
     */
    public ClientEUIDMerge(String name) {
        super(name);
    }
     ...
     */
    public void testClientEUIDMerge() throws Exception {
	...
	TMResult res = tm.lidTransfer(conn, eo2, eo1, "SiteA", "3000");
