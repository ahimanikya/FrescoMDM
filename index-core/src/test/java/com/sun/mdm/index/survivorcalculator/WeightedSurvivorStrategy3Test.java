 ...
 * @author Raymond Tam
 */
public class WeightedSurvivorStrategy3Test extends TestCase {
     ...
     */
    public WeightedSurvivorStrategy3Test(String name) {
        super(name);
    }
     ...
     * @throws Exception an error occured
     */
    public void testWeightedSurvivorStrategy3() throws Exception {
    ...
    /** Tests the WeightedSurvivorStrategy using the SystemAgreement criterion
     *
    ...
    public static boolean run(Collection param) throws Exception {
        ...
        if (stcRoot != null)  {
            fs = new FileInputStream(stcRoot 
                    + "/eView/test/src/java/com/sun/mdm/index/survivorcalculator/config/update3.xml");
        }  else  {
            fs = WeightedSurvivorStrategy3Test.class.getClassLoader().getResourceAsStream(
                    ("com/sun/mdm/index/survivorcalculator/config/update3.xml"));
        }
        ...
        String system2 = new String("SiteA");
        String lid2  = new String("1234");
    ...
    public static void main(String[] args) {
        junit.textui.TestRunner.run(new TestSuite(WeightedSurvivorStrategy3Test.class));
    }
