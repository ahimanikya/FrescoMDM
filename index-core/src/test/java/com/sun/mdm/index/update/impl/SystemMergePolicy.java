...
/**
 * Update policy for system object merges.
 * @author  dcidon
 */
public class SystemMergePolicy implements UpdatePolicy {
    
    private final EnterpriseUpdatePolicy mPolicy;
    
    /** Creates a new instance of SystemMergePolicy */
    public SystemMergePolicy() {
