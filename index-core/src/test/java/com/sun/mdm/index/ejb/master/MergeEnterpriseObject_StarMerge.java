 ...
 */
public class MergeEnterpriseObject_StarMerge extends TestCase {
    
    /** Creates new SearchEOTester
     * @see junit.framework.TestCase#
     * @param name required by JUnit
     */
    public MergeEnterpriseObject_StarMerge(String name) {
        super(name);
    }
    ...
    public void testTMTest() throws Exception {
        ...
        List eoList = helper.run(new String[] {"fileName=MergeEnterpriseObject_StarMerge.txt", "fileType=eiEvent"});
        ...
        EnterpriseObject afterEO2 = rr.getAfterEO2();
        ...
        String[] mergeCommand2 = {"euidSource=" + euid3, "euidDest=" + euid2, "calcOnly=" + calcOnly}; 
        ...
        assertTrue(afterEO2 != null);    // after EUID unmerge, afterEO2 should  be not null
    ...
    public static void main(String[] args) {
        junit.textui.TestRunner.run(new TestSuite(MergeEnterpriseObject_StarMerge.class));
    }
