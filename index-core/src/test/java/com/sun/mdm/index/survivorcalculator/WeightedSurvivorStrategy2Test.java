 ...
 * @author Raymond Tam
 */
public class WeightedSurvivorStrategy2Test extends TestCase {
    ...
    /**  instance of STC_ROOT */
    private static String stcRoot;
    
    /** Creates new instance
     * @see junit.framework.TestCase#
     * @param name required by JUnit
     */
    public WeightedSurvivorStrategy2Test(String name) {
        super(name);
    }
     ...
     * @throws Exception an error occured
     */
    public void testWeightedSurvivorStrategy2() throws Exception {
    ...
    /** Tests the WeightedSurvivorStrategy using the SourceSystem criterion
     *
    ...
    public static boolean run(Collection param) throws Exception {
        ...
        if (stcRoot != null)  {
            fs = new FileInputStream(stcRoot 
                    + "/eView/test/src/java/com/sun/mdm/index/survivorcalculator/config/update2.xml");
        }  else  {
            fs = WeightedSurvivorStrategy2Test.class.getClassLoader().getResourceAsStream(
                    ("com/sun/mdm/index/survivorcalculator/config/update2.xml"));
        }
        ...
        phone1.setPhoneType(testPhoneType1);
        ...
        if (values != null)  {
            //  Only testphone1 should be present.
            int index = values.indexOf(testPhone0);
            if (index == -1)  {
                System.out.println("Phone " + testPhone0 + " not found (expected result)");
            }  else  {
                System.out.println("Error: phone " + testPhone0 + " found but not expected");
                return false;
            }
            index = values.indexOf(testPhone1);
            if (index == -1)  {
                System.out.println("Error: phone " + testPhone1 + " not found but expected");
                return false;
            }  else  {
                System.out.println("Phone " + testPhone1 + " found (expected result)");
            }
    ...
    public static void main(String[] args) {
        junit.textui.TestRunner.run(new TestSuite(WeightedSurvivorStrategy2Test.class));
    }
