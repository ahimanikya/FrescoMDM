 ...
 * @author gzheng
 */
public class ClientAddAlias2 extends TestCase {
    /**
     * constructor
     * @param name name
     */
    public ClientAddAlias2(String name) {
        super(name);
    }
     ...
     */
    public void testClientAddAlias2() throws Exception {
        ...
        alias.setFirstName("Gary2");
        alias.setLastName("Zheng2");
        alias.setMiddleName("G2");


        SystemObject so 
        = (SystemObject) EPathAPI.getFieldValue(
            "Enterprise.SystemObject[@SystemCode=" + syscode + ",@LocalID=" + lid + "].*", eo);
