...
/** Interface fulfilled by eiEvent and HL7 parsers
 * @author Dan Cidon
 */
public interface SystemObjectIterator {
 
    /** Get next record in the iterator
     * @throws ProcessingException an error occured
     * @return next element
     */
    public IteratorRecord next() throws ProcessingException;
    /** Determine if there are more records in the iterator
     * @throws IOException
