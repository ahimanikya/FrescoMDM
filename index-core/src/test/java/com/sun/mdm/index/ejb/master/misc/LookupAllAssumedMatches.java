...
/**  Looks up all assumed matches
 *
 * @author  rtam
 * @version 
 */

public class LookupAllAssumedMatches {
    
    /** Creates a new LookupAssumedMatch instance
     *
     */
    public LookupAllAssumedMatches() {
    }
    ...
    public static void main(String[] args) {
        ...
        boolean rc = lookupAllAssumedMatchesHelper(server, system);
        cleanup();
        if (rc)   {
            System.exit(0);
        }  else  {
     ...
     */    
    public static boolean lookupAllAssumedMatchesHelper(String server, String system)  {
