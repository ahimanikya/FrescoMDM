...
/** Helper class for getMergeHistory unit test
 * @author Dan Cidon
 */
public class GetMergeHistoryHelper extends BasicHelper {
    
    /** Constructor
     */    
    public GetMergeHistoryHelper() {       
    }
     ...
     */
    /*
    public MergeHistoryNode run(String args[]) throws Exception {
        setArgs(args);
        String euid = (String) mArgValues.get("euid");
        MasterController mc = getMasterController();
        MergeHistoryNode node = mc.getMergeHistory(euid);
        return node;
    }
    */
    /**
