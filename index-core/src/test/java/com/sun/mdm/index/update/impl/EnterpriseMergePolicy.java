...
/**
 * Update policy for enterprise merges.
 * @author  dcidon
 */
public class EnterpriseMergePolicy implements UpdatePolicy {
    
    private final EnterpriseUpdatePolicy mPolicy;
    
    /** Creates a new instance of EnterpriseMergePolicy */
    public EnterpriseMergePolicy() {
        mPolicy = new EnterpriseUpdatePolicy();
    }
