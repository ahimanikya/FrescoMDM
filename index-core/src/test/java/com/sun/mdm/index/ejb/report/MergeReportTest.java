 ...
 * @author Dan Cidon
 */
public class MergeReportTest extends TestCase {
    ...
    public void testMergeReport() throws Exception {
        ...
        //Unmerge the records (just to see if it breaks things)
        ...
        MergeReportConfig config = new MergeReportConfig();
        config.addTransactionField(MergeReport.EUID1, "EUID1", 20);
        config.addTransactionField(MergeReport.EUID2, "EUID2", 20);
        config.addTransactionField(MergeReport.TRANSACTION_NUMBER, "TransactionNumber", 20);
        ...
        MergeReport report = repgen.execMergeReport(config);
    ...
    public static void main(String[] args) {
        junit.textui.TestRunner.run(new TestSuite(MergeReportTest.class));
    }
