 ...
 * @author gzheng
 */
public class ClientEUIDMergeRecreate extends TestCase {
    /**
     * constructor
     * @param name name
     */
    public ClientEUIDMergeRecreate(String name) {
        super(name);
    }
     ...
     */
    public void testClientEUIDMergeRecreate() throws Exception {
        TestUtils test = new TestUtils();
        TransactionMgr tm = test.getTransactionMgr();
        Connection conn = test.getConnection();
        
        String tid = test.getTMID(test.EUIDMERGE);
