 ...
 * @author Dan Cidon
 */
public class CreateEnterpriseObject extends TestCase {
    
    /** Creates new SearchEOTester
     * @see junit.framework.TestCase#
     * @param name required by JUnit
     */
    public CreateEnterpriseObject(String name) {
        super(name);
    }
    ...
    public void test1() throws Exception {
        String[] args = { 
            "fileName=CreateEnterpriseObject1.txt",
            "fileType=generic"
        };
    ...
    public static void main(String[] args) {
        junit.textui.TestRunner.run(new TestSuite(CreateEnterpriseObject.class));
    }
