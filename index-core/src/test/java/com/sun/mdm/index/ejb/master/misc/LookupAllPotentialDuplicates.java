...
public class LookupAllPotentialDuplicates {

    /** Creates a new LookupAllPotentialDuplicates instance
     *
     */
    public LookupAllPotentialDuplicates() {
    }
    ...
    public static void main(String[] args) {
        ...
        boolean rc = lookupAllPotentialDuplicatesHelper(server);
        cleanup();
        if (rc)   {
            System.exit(0);
        }  else  {
    ...
    /** Looks up all potential duplicates 
     *
     * @param server  server to access
     * @return  true if successful, false otherwise
     */    
    public static boolean lookupAllPotentialDuplicatesHelper(String server) {
