 ...
 * @author gzheng
 */
public class ClientAddAliasRecreate2 extends TestCase {
    /**
     * constructor
     * @param name name
     */
    public ClientAddAliasRecreate2(String name) {
        super(name);
    }
     ...
     */
    public void testClientAddAliasRecreate2() throws Exception {
        TestUtils test = new TestUtils();
        TransactionMgr tm = test.getTransactionMgr();
        Connection conn = test.getConnection();
        
        String tid = test.getTMID(test.ADDALIAS2);
