 ...
 * @author Jeff Lin
 */
public class TMTest3 extends TestCase {
    
    /** Creates new SearchEOTester
     * @see junit.framework.TestCase#
     * @param name required by JUnit
     */
    public TMTest3(String name) {
        super(name);
    }
     ...
     */
    public void testTMTest3() throws Exception {
        // Create EO 1 and 2
    ...
    public static void main(String[] args) {
        junit.textui.TestRunner.run(new TestSuite(TMTest3.class));
    }
