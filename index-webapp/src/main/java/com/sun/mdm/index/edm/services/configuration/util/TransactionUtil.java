 ...
 */
public class TransactionUtil extends ScreenUtil {

    private static final String FIELD_NAME_XA_EUID1 = "EUID";
    private static final String FIELD_NAME_XA_EUID2 = "EUID2";
    private static final String FIELD_NAME_LID1 = "LID";
    private static final String FIELD_NAME_LID2 = "LID2";
    private static final String FIELD_NAME_TRANSACTION_ID = "TransactionNumber";
    ...
    /**
     * Adds required fields for Transaction searches.
     *
     ...
     */
    public static void addTransactionSearchFields(ObjectNodeConfig nodeConfigObj, 
        ...
        addSearchField(nodeConfigObj.getName(), FIELD_NAME_START_DATE, 
            "From Date", FieldConfig.GUI_TYPE_TEXTBOX, "", DEFAULT_FIELD_LENGTH, 
        ...
        addSearchField(nodeConfigObj.getName(), FIELD_NAME_START_TIME, 
            "From Time", FieldConfig.GUI_TYPE_TEXTBOX, "", DEFAULT_FIELD_LENGTH, 
            "DD:DD:DD", ObjectField.OBJECTMETA_TIMESTAMP_TYPE, false, 
            searchFieldList);
        ...
        addSearchField(nodeConfigObj.getName(), FIELD_NAME_SYSTEM_USER,
            "System User", FieldConfig.GUI_TYPE_TEXTBOX, "", DEFAULT_FIELD_LENGTH, 
            null, ObjectField.OBJECTMETA_STRING_TYPE, false, searchFieldList);
        addSearchField(nodeConfigObj.getName(), FIELD_NAME_FUNCTION, "Function",
            FieldConfig.GUI_TYPE_MENULIST, ValidationService.CONFIG_MODULE_FUNCTION, 
            DEFAULT_FIELD_LENGTH, null, ObjectField.OBJECTMETA_STRING_TYPE, 
            false, searchFieldList);
    }
    
    /**
     * Adds required fields for Transaction search results.
     *
     * @param nodeConfigObj  The ObjectNodeConfig instance.
     ...
     */
    public static void addTransactionResultFields(ObjectNodeConfig nodeConfigObj, 
        ...
        addSearchResultField(nodeConfigObj.getName(), FIELD_NAME_TRANSACTION_ID,
            "Transaction No.", FieldConfig.GUI_TYPE_TEXTBOX, DEFAULT_FIELD_LENGTH,
            ObjectField.OBJECTMETA_STRING_TYPE, false, resultFieldList);
        addSearchResultField(nodeConfigObj.getName(), FIELD_NAME_XA_EUID1, 
            "EUID1", FieldConfig.GUI_TYPE_TEXTBOX, DEFAULT_FIELD_LENGTH, 
            ObjectField.OBJECTMETA_STRING_TYPE, true, resultFieldList);
        addSearchResultField(nodeConfigObj.getName(), FIELD_NAME_XA_EUID2, 
            "EUID2", FieldConfig.GUI_TYPE_TEXTBOX, DEFAULT_FIELD_LENGTH, 
            ObjectField.OBJECTMETA_STRING_TYPE, true, resultFieldList);
        addSearchResultField(nodeConfigObj.getName(), FIELD_NAME_SYSTEM, 
            "System", FieldConfig.GUI_TYPE_TEXTBOX, DEFAULT_FIELD_LENGTH, 
            ObjectField.OBJECTMETA_STRING_TYPE, false, resultFieldList);
        addSearchResultField(nodeConfigObj.getName(), FIELD_NAME_LID1, 
            localIdDesignation + "1", FieldConfig.GUI_TYPE_TEXTBOX, 
            DEFAULT_FIELD_LENGTH, ObjectField.OBJECTMETA_STRING_TYPE, false, 
            resultFieldList);
        addSearchResultField(nodeConfigObj.getName(), FIELD_NAME_LID2, 
            localIdDesignation + "2", FieldConfig.GUI_TYPE_TEXTBOX, 
            DEFAULT_FIELD_LENGTH, ObjectField.OBJECTMETA_STRING_TYPE, false, 
            resultFieldList);
        addSearchResultField(nodeConfigObj.getName(), FIELD_NAME_FUNCTION,
            "Function", FieldConfig.GUI_TYPE_TEXTBOX, DEFAULT_FIELD_LENGTH,
            ObjectField.OBJECTMETA_STRING_TYPE, false, resultFieldList);
        addSearchResultField(nodeConfigObj.getName(), FIELD_NAME_SYSTEM_USER,
            "System User", FieldConfig.GUI_TYPE_TEXTBOX, DEFAULT_FIELD_LENGTH,
            ObjectField.OBJECTMETA_STRING_TYPE, false, resultFieldList);
        addSearchResultField(nodeConfigObj.getName(), FIELD_NAME_TIME_STAMP,
            "Timestamp", FieldConfig.GUI_TYPE_TEXTBOX, DEFAULT_FIELD_LENGTH,
