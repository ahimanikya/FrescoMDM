<%-- 
    Document   : calendar
    Created on : Nov 21, 2007, 11:37:04 AM
--%>
<%--
/*
...
<div>
<b>Example Form</b><br/>
Please input a date: <input id="date1" onclick="ds_sh(this);" name="dateName1"  style="cursor: text" /><br />
Please input another date: <input id="date2" onclick="ds_sh(this);" name="dateName2"  style="cursor: text" />
                           <a HREF="javascript:ds_sh(document.calForm.dateName2);">
                              <img  id="calImg1" alt="calendar Image" lass="imgClass" src="./images/cal.gif"/>               
                           </a>
