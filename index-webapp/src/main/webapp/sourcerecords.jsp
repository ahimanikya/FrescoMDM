                        ...
                        <div id="demo" class="yui-navset">
                            ...
                            <div class="yui-content">
                                <div id=viewEditTab">
                                    ...
                                    <!--Start Displaying the AuxId fields -->    
                                     <h:dataTable  
                                        headerClass="tablehead"                                        
                                        width="60%"
                                        rowClasses="odd,even"                                     
                                        ...
                                        var="auxIdMapArrayList" 
                                         value="#{SourceHandler.singleAuxIdHashMapArrayList}">
                                        <f:facet name="header">
                                             <h:column>
                                                <h:outputText value="#{msgs.auxid_details_heading}"/>
                                             </h:column>
                                        </f:facet>
                                        <f:facet name="footer">
                                             <h:column>
                                                 <% 
                                                     auxIdSize = sourceHandler.getSingleAuxIdHashMapArrayList().size();
                                                  %>
                                                  <% if (auxIdSize  == 0 ) { %>
                                                       <h:outputText value="#{msgs.source_rec_nodetails_text}"/>
                                                  <%}%>
                                        ...
                                        <h:column>
                                            <h:dataTable  
                                              ...
                                              value="#{SourceHandler.auxIdFieldConfigs}">
                                                ...
                                                <h:column>
                                                    <h:outputText value="#{auxIdMapArrayList[auxIdFieldConfig.fullFieldName]}" />
                                                </h:column>
                                            </h:dataTable>               
                                        </h:column>
                                     </h:dataTable> 
                                    <!--End Displaying the auxId fields -->    

                                    <!--Start Displaying the Comment fields -->    
                                     <h:dataTable  
                                        headerClass="tablehead"                                        
                                        width="60%"
                                        rowClasses="odd,even"                                     
                                       ...
                                       value="#{SourceHandler.singleCommentHashMapArrayList}">
                                        <f:facet name="header">
                                             <h:column>
                                        ...
                                        <f:facet name="footer">
                                             <h:column>
                                                 <% 
                                                     commentSize = sourceHandler.getSingleCommentHashMapArrayList().size();
                                                  %>
                                                  <% if (commentSize == 0 ) { %>
                                                       <h:outputText value="#{msgs.source_rec_nodetails_text}"/>
                                                  <%}%>
                                        ...
                                        <h:column>
                                            ...
                                            value="#{SourceHandler.commentFieldConfigs}">
                                                ...
                                                <h:column>
                                                    <h:outputText value="#{commentMapArrayList[commentFieldConfig.fullFieldName]}" />
                                                </h:column>
                                            </h:dataTable>               
                                        </h:column>
                                     </h:dataTable> 
                                    <!--End Displaying the comment fields -->    
                                                ...
                                                <h:column>
                                                    ...
                                                    <h:column rendered="#{addressFieldConfig.guiType eq 'TextBox' &&  addressFieldConfig.valueType eq 6}">
                                                        ...
                                                        <table border="0" width="75%">
                                                            ...
                                                            <tr>
                                                                <td colspan="2" align="right">
                                                                    <a HREF="javascript:void(0);" onclick="javascript:showExtraDivs('extraAuxIdEditDiv',event)" class="button">
                                                                        <span><h:outputText value="#{msgs.source_rec_add_auxid_text}"/></span>
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <h:dataTable  headerClass="tablehead" 
                                                                      ...
                                                                      id="auxIdfieldConfigId" 
                                                                      var="auxIdMapArrayList" 
                                                                      value="#{SourceEditHandler.singleAuxIdHashMapArrayList}">
                                                            <f:facet name="footer">
                                                                <h:column>
                                                                    <%
                                                                       auxIdSize = sourceEditHandler.getSingleAuxIdHashMapArrayList().size();
                                                                    %>
                                                                    <% if (auxIdSize == 0) {%>
                                                                    <h:outputText value="#{msgs.source_rec_nodetails_text}"/>
                                                                    <%}%>
                                                            ...
                                                            <h:column>
                                                                <h:dataTable  headerClass="tablehead" 
                                                                    ...
                                                                    <f:facet name="footer">
                                                                        <h:column>
                                                                            <h:commandLink  styleClass="button" 
                                                                                            actionListener="#{SourceEditHandler.removeSOAuxId}" >  
                                                        ...
                                                        <table border="0" width="75%">
                                                            ...
                                                            <tr>
                                                                <td colspan="2" align="right">
                                                                    <a HREF="javascript:void(0);" onclick="javascript:showExtraDivs('extraCommentEditDiv',event)" class="button">
                                                                        <span><h:outputText value="#{msgs.source_rec_add_comment_text}"/></span>
                                                                        </a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <h:dataTable  headerClass="tablehead" 
                                                                      ...
                                                                      id="commentfieldConfigId" 
                                                                      var="commentMapArrayList" 
                                                                      value="#{SourceEditHandler.singleCommentHashMapArrayList}">
                                                            <f:facet name="footer">
                                                                <h:column>
                                                                    <%
                                                                      commentSize = sourceEditHandler.getSingleCommentHashMapArrayList().size();
                                                                    %>
                                                                    <% if (commentSize == 0) {%>
                                                                    <h:outputText value="#{msgs.source_rec_nodetails_text}"/>
                                                                    <%}%>
                                                            ...
                                                            <h:column>
                                                                <h:dataTable  headerClass="tablehead" 
                                                                    ...
                                                                    <f:facet name="footer">
                                                                        <h:column>
                                                                            <h:commandLink  styleClass="button" 
                                                                                            actionListener="#{SourceEditHandler.removeSOComment}" >  
                                                                                <f:attribute name="remCommentMap" value="#{commentMapArrayList}"/>
                                                                                <span><h:outputText value="#{msgs.source_rec_delete_comment_text}"/></span>
                                                                            </h:commandLink>                                     
                                                                        </h:column>
                                                                    </f:facet>
                                                        ...
                                                        <h:dataTable  headerClass="tablehead" 
                                                            ...
                                                            <h:column>
                                                                <h:dataTable  headerClass="tablehead" 
                                                                              ...
                                                                              rowClasses="odd,even"                                     
                                                                              id="auxIdHashId" 
                                                                              var="auxIdFieldConfigReadOnly" 
                                                                              value="#{SourceHandler.auxIdFieldConfigs}">
                                                                    <h:column>
                                                                        <h:outputText value="#{auxIdFieldConfigReadOnly.displayName}"  />
                                                                        <h:outputText value="*" rendered="#{auxIdFieldConfigReadOnly.required}" />
                                                                    </h:column>
                                                                    <!--Rendering Updateable HTML Text boxes-->
                                                                    <h:column rendered="#{auxIdFieldConfigReadOnly.guiType eq 'TextBox' &&  auxIdFieldConfigReadOnly.valueType ne 6}" >
                                                                        <h:inputText readonly="true" disabled="true"   style="background-color:#efefef;font-color:#efefef"label="#{auxIdFieldConfigReadOnly.displayName}"  
                                                                                     id="fieldConfigIdTextbox"   
                                                                                     value="#{auxIdMapArrayList[auxIdFieldConfigReadOnly.fullFieldName]}" 
                                                                                     required="#{auxIdFieldConfigReadOnly.required}"/>
                                                                    </h:column>
                                                                    
                                                                    
                                                                    <!--Rendering Updateable HTML Text boxes date fields-->
                                                                    <h:column rendered="#{auxIdFieldConfigReadOnly.guiType eq 'TextBox' &&  auxIdFieldConfigReadOnly.valueType eq 6}">
                                                                        <h:inputText readonly="true" disabled="true"   style="background-color:#efefef;font-color:#efefef"label="#{auxIdFieldConfigReadOnly.displayName}"   
                                                                                     value="#{auxIdMapArrayList[auxIdFieldConfigReadOnly.fullFieldName]}"  
                                                                                     id="date"
                                                                                     required="#{auxIdFieldConfigReadOnly.required}"
                                                                    ...
                                                                    <!--Rendering Updateable HTML Text Area-->
                                                                    <h:column rendered="#{auxIdFieldConfigReadOnly.guiType eq 'TextArea' &&  auxIdFieldConfigReadOnly.valueType ne 6}" >
                                                                        <h:inputTextarea readonly="true" 
                                                                                         disabled="true"
                                                                                         label="#{auxIdFieldConfigReadOnly.displayName}"  
                                                                                         id="fieldConfigIdTextArea"   
                                                                                         value="#{auxIdMapArrayList[auxIdFieldConfigReadOnly.fullFieldName]}" 
                                                                                         required="#{auxIdFieldConfigReadOnly.required}"/>
                                                                    </h:column>
                                                        ...
                                                        <h:dataTable  headerClass="tablehead" 
                                                            ...
                                                            <h:column>
                                                                <h:dataTable  headerClass="tablehead" 
                                                                              ...
                                                                              width="100%"
                                                                              rowClasses="odd,even"                                     
                                                                              var="commentFieldConfigReadOnly" 
                                                                              value="#{SourceHandler.commentFieldConfigs}">
                                                                    <h:column>
                                                                        <h:outputText value="#{commentFieldConfigReadOnly.displayName}"  />
                                                                        <h:outputText value="*" rendered="#{commentFieldConfigReadOnly.required}" />
                                                                    </h:column>
                                                                    <!--Rendering HTML Select Menu List-->
                                                                    <h:column rendered="#{commentFieldConfigReadOnly.guiType eq 'MenuList' &&  commentFieldConfigReadOnly.valueType ne 6}" >
                                                                        <h:selectOneMenu readonly="true" disabled="true"   style="background-color:#efefef;font-color:#efefef"value="#{commentMapArrayList[commentFieldConfigReadOnly.fullFieldName]}" >
                                                                            <f:selectItem itemLabel="" itemValue="" />
                                                                            <f:selectItems  value="#{commentFieldConfigReadOnly.selectOptions}"  />
                                                                        </h:selectOneMenu>
                                                                    </h:column>
                                                                    
                                                                    <!--Rendering Updateable HTML Text boxes-->
                                                                    <h:column rendered="#{commentFieldConfigReadOnly.guiType eq 'TextBox' &&  commentFieldConfigReadOnly.valueType ne 6}" >
                                                                        <h:inputText readonly="true" disabled="true"   style="background-color:#efefef;font-color:#efefef"label="#{commentFieldConfigReadOnly.displayName}"  
                                                                                     id="fieldConfigIdTextbox"   
                                                                                     value="#{commentMapArrayList[commentFieldConfigReadOnly.fullFieldName]}" 
                                                                                     required="#{commentFieldConfigReadOnly.required}"/>
                                                                    </h:column>
                                                                    
                                                                    
                                                                    <!--Rendering Updateable HTML Text boxes date fields-->
                                                                    <h:column rendered="#{commentFieldConfigReadOnly.guiType eq 'TextBox' &&  commentFieldConfigReadOnly.valueType eq 6}">
                                                                        <h:inputText readonly="true" disabled="true"   style="background-color:#efefef;font-color:#efefef"label="#{commentFieldConfigReadOnly.displayName}"   
                                                                                     value="#{commentMapArrayList[commentFieldConfigReadOnly.fullFieldName]}"  
                                                                                     id="date"
                                                                                     required="#{commentFieldConfigReadOnly.required}"
                                                                    ...
                                                                    <!--Rendering Updateable HTML Text Area-->
                                                                    <h:column rendered="#{commentFieldConfigReadOnly.guiType eq 'TextArea' &&  commentFieldConfigReadOnly.valueType ne 6}" >
                                                                        <h:inputTextarea readonly="true" disabled="true"
                                                                                         label="#{commentFieldConfigReadOnly.displayName}"  
                                                                                         id="fieldConfigIdTextArea"   
                                                                                         value="#{commentMapArrayList[commentFieldConfigReadOnly.fullFieldName]}" 
                                                                                         required="#{commentFieldConfigReadOnly.required}"/>
                                                                    </h:column>
                                                ...
                                                <td>
                                                    ...
                                                    <!--Start Displaying the person fields -->  
                                                        ...
                                                        <table border="0" width="100%">
                                                            ...
                                                            <tr>
                                                                <td colspan="2" align="right">
                                                                    <a HREF="javascript:void(0);" onclick="javascript:showExtraDivs('extraAuxIdAddDiv',event)" class="button">
                                                                        <span><h:outputText value="#{msgs.source_rec_add_auxid_text}"/></span>
                                                                        </a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <div id="addAuxIdDiv" style="width:100%;visibility:hidden;"></div>
                                                        <div id="addAuxIdDivClose" style="visibility:hidden;">
                                                            <table>
                                                                <tr>
                                                                    <td align="right" colspan="2">
                                                                        <a href="javascript:closeExtraDivs('addAuxIdDiv','addAuxIdDivClose')" class="button">
                                                                            <span><h:outputText value="#{msgs.source_rec_delete_auxid_text}"/></span></a>
                                                                    </td>
                                                        ...
                                                        <table border="0" width="100%">
                                                            ...
                                                            <tr>
                                                                <td colspan="2" align="right">
                                                                    <a HREF="javascript:void(0);" onclick="javascript:showExtraDivs('extraCommentAddDiv',event)" class="button">
                                                                        <span><h:outputText value="#{msgs.source_rec_add_comment_text}"/> </span></a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <div id="addCommentDiv" style="width:100%;visibility:hidden;"></div>
                                                        <div id="addCommentDivClose" style="visibility:hidden;">
                                                            <table><h:outputText value="#{msgs.source_rec_delete_comment_text}"/>
                                                                <tr>
                                                                    <td align="right" colspan="2">
                                                                        <a href="javascript:closeExtraDivs('addCommentDiv','addCommentDivClose')" class="button">
                                                                            <span><h:outputText value="#{msgs.source_rec_delete_comment_text}"/></span></a>&nbsp;
                                                                    </td>
...
%>
    ...
    <div id="extraAuxIdEditDiv" style="TOP: 1550px; LEFT: 500px; HEIGHT: 100px;  WIDTH: 300px; BORDER-RIGHT: #000099 thin solid; font-color:red;BORDER-TOP: #000099 thin solid; PADDING-LEFT: 5px; VISIBILITY: hidden; BORDER-LEFT: #000099 thin solid; PADDING-TOP: 5px; BORDER-BOTTOM: #000099 thin solid; BACKGROUND-REPEAT: no-repeat; POSITION: absolute; BACKGROUND-COLOR:#f9f7de ;">
         ...
         <h:form>
             <table>
                 <tr>
                     <td align="right" colspan="2">
                         <div>
                             <a href="javascript:void(0)" rel="editballoonaux"><h:outputText value="#{msgs.help_link_text}"/> </a><br/>
                         </div>
                     </td>
                 </tr>
                 <tr>
                         ...
                         <h:dataTable  headerClass="tablehead" 
                             ...
                             <h:column rendered="#{fieldConfigEditAuxId.guiType eq 'TextBox'}" >
                                 <h:inputText label="#{fieldConfigEditAuxId.displayName}"  
                                              value="#{SourceEditHandler.editSoAuxIdHashMap[fieldConfigEditAuxId.fullFieldName]}" 
                 ...
                 <tr>
                     <td>
                         <h:commandLink  styleClass="button" 
                                         actionListener="#{SourceEditHandler.addSOAuxId}">
                            <span> <h:outputText value="#{msgs.ok_text_button}"/></span>
                         </h:commandLink>   
                     </td>
                     <td>
    ...
    <div id="extraCommentEditDiv" style="TOP: 1850px; LEFT: 500px; HEIGHT: 200px;  WIDTH: 400px; BORDER-RIGHT: #000099 thin solid; font-color:red;BORDER-TOP: #000099 thin solid; PADDING-LEFT: 5px; VISIBILITY: hidden; BORDER-LEFT: #000099 thin solid; PADDING-TOP: 5px; BORDER-BOTTOM: #000099 thin solid; BACKGROUND-REPEAT: no-repeat; POSITION: absolute; BACKGROUND-COLOR:#f9f7de ;">
      <iframe src="Blank.html" scrolling="no" frameborder="0" style="width:400px; height:200px; z-index: -1; position: absolute; filter: progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0);">
         ...
         <h:form>
             <table>
                     ...
                     <td colspan="2">
                         <h:dataTable  headerClass="tablehead" 
                             ...
                             <h:column rendered="#{fieldConfigEditComment.guiType eq 'MenuList'}" >
                                 <h:selectOneMenu value="#{SourceEditHandler.editSoCommentHashMap[fieldConfigEditComment.fullFieldName]}">
                                     <f:selectItem itemLabel="" itemValue="" />
                             ...
                             <h:column rendered="#{fieldConfigEditComment.guiType eq 'TextBox'}" >
                                 <h:inputText label="#{fieldConfigEditComment.displayName}"  
                                              value="#{SourceEditHandler.editSoCommentHashMap[fieldConfigEditComment.fullFieldName]}" 
                 ...
                 <tr>
                     <td>
                         <h:commandLink  styleClass="button" 
                                         actionListener="#{SourceEditHandler.addSOComment}">
                            <span> <h:outputText value="#{msgs.ok_text_button}"/></span>
                         </h:commandLink>   
                      </td>
                     <td>
...
<div id="extraAuxIdAddDiv" style="TOP: 2100px; LEFT: 700px; HEIGHT: 150px;  WIDTH: 250px; BORDER-RIGHT: #000099 thin solid; font-color:red;BORDER-TOP: #000099 thin solid; PADDING-LEFT: 5px; VISIBILITY: hidden; BORDER-LEFT: #000099 thin solid; PADDING-TOP: 5px; BORDER-BOTTOM: #000099 thin solid; BACKGROUND-REPEAT: no-repeat; POSITION: absolute; BACKGROUND-COLOR:#f9f7de ;">
    <iframe src="Blank.html" scrolling="no" frameborder="0" style="width:250px; height:150px; z-index: -1; position: absolute; filter: progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0);">
    </iframe>
    <table>
        <tr>
            <td align="right" colspan="2">
                  <div>
                    <a href="javascript:void(0)" rel="addballoonaux"><h:outputText value="#{msgs.help_link_text}"/></a><br/>
                </div>                               
             </td>
        ...
        <tr>
            <td colspan="2">
                <div id="auxIdInnerDiv">
                    <h:dataTable  headerClass="tablehead" 
                                  id="hashAuxIdIdExtra" 
                                  var="fieldConfigAddAuxId" 
                                  rowClasses="odd,even"                                     
                                  value="#{SourceAddHandler.auxIdFieldConfigs}">
                        <h:column>
                            <h:outputText value="#{fieldConfigAddAuxId.displayName}"  />
                            <h:outputText value="*" rendered="#{fieldConfigAddAuxId.required}" />
                        </h:column>
                        <!--Rendering HTML Select Menu List-->
                        <!--Rendering Updateable HTML Text boxes-->
                                                                <h:column rendered="#{fieldConfigAddAuxId.updateable && fieldConfigAddAuxId.guiType eq 'TextBox' &&  fieldConfigAddAuxId.valueType ne 6}" >
                                                                    <h:inputText label="#{fieldConfigAddAuxId.displayName}"  
                                                                                 id="fieldConfigIdTextbox"   
                                                                                 value="#{SourceAddHandler.auxIdFeildsMap[fieldConfigAddAuxId.fullFieldName]}" 
                                                                                 required="#{fieldConfigAddAuxId.required}"/>
                                                                </h:column>                     
                                                                <!--Rendering Updateable HTML Text boxes date fields-->
                                                                <h:column rendered="#{fieldConfigAddAuxId.guiType eq 'TextBox' &&  fieldConfigAddAuxId.valueType eq 6}">
                                                                    <h:inputText label="#{fieldConfigAddAuxId.displayName}"   
                                                                                 value="#{SourceAddHandler.auxIdFeildsMap[fieldConfigAddAuxId.fullFieldName]}"  
                                                                                 id="date"
                                                                                 required="#{fieldConfigAddAuxId.required}"
                        ...
                        <!--Rendering Updateable HTML Text Area-->
                        <h:column rendered="#{fieldConfigAddAuxId.guiType eq 'TextArea' &&  fieldConfigAddAuxId.valueType ne 6}" >
                            <h:inputTextarea label="#{fieldConfigAddAuxId.displayName}"  
                                             id="fieldConfigIdTextArea"   
                                             value="#{SourceAddHandler.auxIdFeildsMap[fieldConfigAddAuxId.fullFieldName]}" 
                                             required="#{fieldConfigAddAuxId.required}"
        ...
        <tr>
            <td align="right">
                <a href="javascript:populateExtraDivs('auxIdInnerDiv','addAuxIdDiv','extraAuxIdAddDiv','addAuxIdDivClose')" class="button"><span><h:outputText value="#{msgs.ok_text_button}"/><span></a>    
            </td>
            <td>
                <a HREF="javascript:void(0);" onclick="javascript:showExtraDivs('extraAuxIdAddDiv',event)" class="button"> 
                <span><h:outputText value="#{msgs.cancel_but_text}"/> </span></a>
...
<div id="extraCommentAddDiv" style="TOP: 2100px; LEFT: 700px; HEIGHT: 200px;  WIDTH: 300px; BORDER-RIGHT: #000099 thin solid; font-color:red;BORDER-TOP: #000099 thin solid; PADDING-LEFT: 5px; VISIBILITY: hidden; BORDER-LEFT: #000099 thin solid; PADDING-TOP: 5px; BORDER-BOTTOM: #000099 thin solid; BACKGROUND-REPEAT: no-repeat; POSITION: absolute; BACKGROUND-COLOR:#f9f7de ;">
    <iframe src="Blank.html" scrolling="no" frameborder="0" style="width:300px; height:200px; z-index: -1; position: absolute; filter: progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0);">
    ...
    <table>
        <tr>
            <td align="right" colspan="2">
                  <div>
                    <a href="javascript:void(0)" rel="addballooncomment"><h:outputText value="#{msgs.help_link_text}"/></a><br/>
                </div>                               
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <div id="commentInnerDiv">
                    <h:dataTable  headerClass="tablehead" 
                                  id="hashCommentIdExtra" 
                                  var="fieldConfigAddComment" 
                                  rowClasses="odd,even"                                     
                                  value="#{SourceAddHandler.commentFieldConfigs}">
                        <h:column>
                            <h:outputText value="#{fieldConfigAddComment.displayName}"  />
                            <h:outputText value="*" rendered="#{fieldConfigAddComment.required}" />
                        </h:column>
                        <!--Rendering HTML Select Menu List-->
                        <h:column rendered="#{fieldConfigAddComment.guiType eq 'MenuList' &&  fieldConfigAddComment.valueType ne 6}" >
                            <h:selectOneMenu value="#{SourceAddHandler.commentFeildsMap[fieldConfigAddComment.fullFieldName]}">
                                <f:selectItem itemLabel="" itemValue="" />
                                <f:selectItems  value="#{fieldConfigAddComment.selectOptions}"  />
                            </h:selectOneMenu>
                        </h:column>
                        <!--Rendering Updateable HTML Text boxes-->
                        <h:column rendered="#{fieldConfigAddComment.guiType eq 'TextBox' &&  fieldConfigAddComment.valueType ne 6}" >
                            <h:inputText label="#{fieldConfigAddComment.displayName}"  
                                         id="fieldConfigIdTextbox"   
                                         value="#{SourceAddHandler.commentFeildsMap[fieldConfigAddComment.fullFieldName]}" 
                                         required="#{fieldConfigAddComment.required}"/>
                        </h:column>                     
                        <!--Rendering Updateable HTML Text boxes date fields-->
                        <h:column rendered="#{fieldConfigAddComment.guiType eq 'TextBox' &&  fieldConfigAddComment.valueType eq 6}">
                            <h:inputText label="#{fieldConfigAddComment.displayName}"   
                                         value="#{SourceAddHandler.commentFeildsMap[fieldConfigAddComment.fullFieldName]}"  
                                         id="commentDate"
                                         required="#{fieldConfigAddComment.required}"
                                         ...
                                         onkeyup="javascript:qws_field_on_key_up(this)" 
                                         />
                            <script> var commentDate = getDateFieldName('CommentForm',':commentDate');</script>                                                                            
                            <a HREF="javascript:void(0);" 
                               onclick="g_Calendar.show(event,commentDate)" > 
                                <h:graphicImage  id="calImgStartDate" 
                                                 alt="calendar Image" styleClass="imgClass"
                                                 url="./images/cal.gif"/>               
                            </a>
                        ...
                        <!--Rendering Updateable HTML Text Area-->
                        <h:column rendered="#{fieldConfigAddComment.guiType eq 'TextArea' &&  fieldConfigAddComment.valueType ne 6}" >
                            <h:inputTextarea label="#{fieldConfigAddComment.displayName}"  
                                             id="fieldConfigIdTextArea"   
                                             value="#{SourceAddHandler.commentFeildsMap[fieldConfigAddComment.fullFieldName]}" 
                                             required="#{fieldConfigAddComment.required}"
        ...
        <tr>
            <td align="right">
                <a href="javascript:populateExtraDivs('commentInnerDiv','addCommentDiv','extraCommentAddDiv','addCommentDivClose')" class="button">
                    <span><h:outputText value="#{msgs.ok_text_button}"/></span>
                    </a>    
            </td>
            <td>
