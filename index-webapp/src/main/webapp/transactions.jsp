...
<%
   ...
   TransactionHandler  transactionHandler = (facesSession.getAttribute("TransactionHandler") != null ) ? (TransactionHandler) facesSession.getAttribute("TransactionHandler") : new TransactionHandler();
                    ...
                    <h:form id="advancedformData">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" >
        		           <tr>
							...
							<%
							  for(int i = 0 ; i < transactionHandler.getSearchScreenFieldGroupArray().size(); i++) {
                                 FieldConfigGroup basicSearchFieldGroup = (FieldConfigGroup) transactionHandler.getSearchScreenFieldGroupArray().get(i);
							...
							%>
							   ...
							   <%}%>
                               <%
								 ArrayList fieldGroupArrayList  = (ArrayList)transactionHandler.getSearchScreenHashMap().get(basicSearchFieldGroup.getDescription());
								%>
