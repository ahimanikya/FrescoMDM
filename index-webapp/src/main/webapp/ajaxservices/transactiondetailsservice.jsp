                                                        ...
                                                        <tr>
                                                            <td valign="top" colspan="2">
                                                                <a href="Javascript:void(0)"
																   class="activeviewbtn" 
                                                                   onclick="Javascript:document.getElementById('unmergeTransactionId').value='<%=transactionId%>';document.getElementById('mainEuid').value='<%=mainEuid%>';document.getElementById('unmergeEuid').innerHTML='<%=euid%>';showExtraDivs('unmergePopupDiv',event)"
