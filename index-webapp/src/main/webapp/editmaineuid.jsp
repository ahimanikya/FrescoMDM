                                             ...
                                             <h:dataTable  headerClass="tablehead"                                        
                                                 ...
                                                 <!--Rendering HTML Select Menu List-->
                                                    <h:column rendered="#{fieldConfigPer.guiType eq 'MenuList' &&  fieldConfigPer.valueType ne 6}" >
                                                        <h:selectOneMenu value="#{EditMainEuidHandler.editSingleEOHashMap[fieldConfigPer.fullFieldName]}" >
                                                    ...
                                                    <h:column rendered="#{fieldConfigPer.updateable && fieldConfigPer.guiType eq 'TextBox' &&  fieldConfigPer.valueType ne 6}" >
                                                        <h:inputText label="#{fieldConfigPer.displayName}"  
                                                                     ...
                                                                     value="#{EditMainEuidHandler.editSingleEOHashMap[fieldConfigPer.fullFieldName]}" 
                                    ...
                                    %>   
                                     <td valign="top">
                                        <h:dataTable  headerClass="tablehead"                                        
                                                      ...
                                                      rowClasses="odd,even"                                     
                                                      id="hashIdEditEo" 
                                                      style="background:#efefef;border-top:1px solid #efefef;border-left:1px solid #efefef;border-right:1px solid #efefef;border-bottom:1px solid #efefef;"    
...
<div id="lockSoDiv" style="TOP: 620px; LEFT: 450px; HEIGHT: 100px;  WIDTH: 100px; BORDER-RIGHT: #000099 thin solid; font-color:red;BORDER-TOP: #000099 thin solid; PADDING-LEFT: 5px; VISIBILITY: hidden; BORDER-LEFT: #000099 thin solid; PADDING-TOP: 5px; BORDER-BOTTOM: #000099 thin solid; BACKGROUND-REPEAT: no-repeat; POSITION: absolute; BACKGROUND-COLOR:#f9f7de ;">
         <iframe src="Blank.html" scrolling="no" frameborder="0" style="width:100px; height:100px; z-index: -1; position: absolute; filter: progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0);">
