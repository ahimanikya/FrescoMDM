...
ALTER TABLE SBYN_EXISTINGCON ADD CONSTRAINT U_EXISTINGCON UNIQUE (AUSPATIENTID, CONNAME) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE SBYN_EXISTINGCONSBR ADD CONSTRAINT U_EXISTINGCONSBR UNIQUE (AUSPATIENTID, CONNAME) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE SBYN_CONTACT ADD CONSTRAINT U_CONTACT UNIQUE (AUSPATIENTID, CONTACTFNAME, CONTACTMNAME, CONTACTLNAME) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE SBYN_CONTACTSBR ADD CONSTRAINT U_CONTACTSBR UNIQUE (AUSPATIENTID, CONTACTFNAME, CONTACTMNAME, CONTACTLNAME) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE SBYN_HEATHFUND ADD CONSTRAINT U_HEATHFUND UNIQUE (AUSPATIENTID, COMPANYNAME, MEMBERSHIPNO) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE SBYN_HEATHFUNDSBR ADD CONSTRAINT U_HEATHFUNDSBR UNIQUE (AUSPATIENTID, COMPANYNAME, MEMBERSHIPNO) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE SBYN_AUXID ADD CONSTRAINT U_AUXID UNIQUE (AUSPATIENTID, AUXIDDEF, ID) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE SBYN_AUXIDSBR ADD CONSTRAINT U_AUXIDSBR UNIQUE (AUSPATIENTID, AUXIDDEF, ID) DEFERRABLE INITIALLY DEFERRED;
