...
CREATE TABLE SBYN_USACITIZEN (
	...
	RACE VARCHAR2(8),
	POBCITY VARCHAR2(40),
	POBSTATECODE VARCHAR2(10),
	POBCOUNTRY VARCHAR2(40),
	DOD DATE,
	HEIGHT FLOAT,
	HAIRCOLOR VARCHAR2(8),
	EYECOLOR VARCHAR2(8),
...
ALTER TABLE SBYN_PASSPORT ADD CONSTRAINT U_PASSPORT UNIQUE (USACITIZENID, BOOKNUMBER) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE SBYN_PASSPORTSBR ADD CONSTRAINT U_PASSPORTSBR UNIQUE (USACITIZENID, BOOKNUMBER) DEFERRABLE INITIALLY DEFERRED;

CREATE TABLE SBYN_OTHERIDS (
	USACITIZENID VARCHAR2(20),
	OTHERIDSID VARCHAR2(20),
	IDTYPE VARCHAR2(8),
	IDENTIFICATION VARCHAR2(56),
	IDSTATECODE VARCHAR2(8))
		;

ALTER TABLE SBYN_OTHERIDS ADD CONSTRAINT FK_OTHERIDS_USACITIZENID FOREIGN KEY (USACITIZENID) REFERENCES SBYN_USACITIZEN(USACITIZENID) DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE SBYN_OTHERIDS ADD CONSTRAINT PK_OTHERIDS PRIMARY KEY (OTHERIDSID);
ALTER TABLE SBYN_OTHERIDS ADD CONSTRAINT U_OTHERIDS UNIQUE (USACITIZENID, IDTYPE) DEFERRABLE INITIALLY DEFERRED;

CREATE TABLE SBYN_OTHERIDSSBR (
	USACITIZENID VARCHAR2(20),
	OTHERIDSID VARCHAR2(20),
	IDTYPE VARCHAR2(8),
	IDENTIFICATION VARCHAR2(56),
...
ALTER TABLE SBYN_OTHERIDSSBR ADD CONSTRAINT FK_OTHERIDSSBR_USACITIZENID FOREIGN KEY (USACITIZENID) REFERENCES SBYN_USACITIZENSBR(USACITIZENID) DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE SBYN_OTHERIDSSBR ADD CONSTRAINT PK_OTHERIDSSBR PRIMARY KEY (OTHERIDSID);
ALTER TABLE SBYN_OTHERIDSSBR ADD CONSTRAINT U_OTHERIDSSBR UNIQUE (USACITIZENID, IDTYPE) DEFERRABLE INITIALLY DEFERRED;

CREATE TABLE SBYN_FAMILY (
	USACITIZENID VARCHAR2(20),
	FAMILYID VARCHAR2(20),
	MEMBERTYPE VARCHAR2(8),
	MEMBERFIRSTNAME VARCHAR2(40),
	MEMBERLASTNAME VARCHAR2(40),
	MEMBERMIDDLENAME VARCHAR2(40),
	MEMBERDOB DATE,
	MEMBERPOBCITY VARCHAR2(40),
	MEMBERPOBSTATECODE VARCHAR2(8),
	MEMBERPOBCOUNTRY VARCHAR2(40),
	MEMBERUSCITIZEN VARCHAR2(1),
	MEMBERDOD DATE,
	MEMBERWASMARRIED VARCHAR2(1),
	MEMBERDIVORCED VARCHAR2(1),
	MEMBERWIDOWED VARCHAR2(1),
	MEMBERLASTMARRIED DATE,
	MEMBERPHONE VARCHAR2(14),
	MEMBERPHONEEXT VARCHAR2(6),
	MEMBEREMAIL VARCHAR2(40))
		;

ALTER TABLE SBYN_FAMILY ADD CONSTRAINT FK_FAMILY_USACITIZENID FOREIGN KEY (USACITIZENID) REFERENCES SBYN_USACITIZEN(USACITIZENID) DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE SBYN_FAMILY ADD CONSTRAINT PK_FAMILY PRIMARY KEY (FAMILYID);
ALTER TABLE SBYN_FAMILY ADD CONSTRAINT U_FAMILY UNIQUE (USACITIZENID, MEMBERTYPE) DEFERRABLE INITIALLY DEFERRED;

CREATE TABLE SBYN_FAMILYSBR (
	USACITIZENID VARCHAR2(20),
	FAMILYID VARCHAR2(20),
	MEMBERTYPE VARCHAR2(8),
	MEMBERFIRSTNAME VARCHAR2(40),
...
ALTER TABLE SBYN_FAMILYSBR ADD CONSTRAINT FK_FAMILYSBR_USACITIZENID FOREIGN KEY (USACITIZENID) REFERENCES SBYN_USACITIZENSBR(USACITIZENID) DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE SBYN_FAMILYSBR ADD CONSTRAINT PK_FAMILYSBR PRIMARY KEY (FAMILYID);
ALTER TABLE SBYN_FAMILYSBR ADD CONSTRAINT U_FAMILYSBR UNIQUE (USACITIZENID, MEMBERTYPE) DEFERRABLE INITIALLY DEFERRED;
...
CREATE TABLE SBYN_CONTACT (
	...
	CONTACTSTATECODE VARCHAR2(8),
	CONTACTPOSTALCODE VARCHAR2(5),
	CONTACTPOSTALCODEEXT VARCHAR2(4),
	CONTACTCOUNTY VARCHAR2(40),
	CONTACTCOUNTRY VARCHAR2(40),
	CONTACTPHONE VARCHAR2(14),
...
INSERT INTO SBYN_SEQ_TABLE VALUES ('OTHERIDS', 0);
INSERT INTO SBYN_SEQ_TABLE VALUES ('OTHERIDSSBR', 0);
INSERT INTO SBYN_SEQ_TABLE VALUES ('FAMILY', 0);
INSERT INTO SBYN_SEQ_TABLE VALUES ('FAMILYSBR', 0);
