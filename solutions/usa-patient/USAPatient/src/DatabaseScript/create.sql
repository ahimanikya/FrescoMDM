...
ALTER TABLE SBYN_EXISTINGCON ADD CONSTRAINT U_EXISTINGCON UNIQUE (USAPATIENTID, CONNAME, STARTDATE) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE SBYN_EXISTINGCONSBR ADD CONSTRAINT U_EXISTINGCONSBR UNIQUE (USAPATIENTID, CONNAME, STARTDATE) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE SBYN_CONTACT ADD CONSTRAINT U_CONTACT UNIQUE (USAPATIENTID, CONTACTFNAME, CONTACTMNAME, CONTACTLNAME) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE SBYN_CONTACTSBR ADD CONSTRAINT U_CONTACTSBR UNIQUE (USAPATIENTID, CONTACTFNAME, CONTACTMNAME, CONTACTLNAME) DEFERRABLE INITIALLY DEFERRED;
...
CREATE TABLE SBYN_INSURANCE (
	...
	PATIENTRELATIONSHIP VARCHAR2(32),
	MEDICAREREL VARCHAR2(32))
		;
...
ALTER TABLE SBYN_INSURANCE ADD CONSTRAINT U_INSURANCE UNIQUE (USAPATIENTID, COMPANYNAME, GROUPID, MEMBERSHIPID) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE SBYN_INSURANCESBR ADD CONSTRAINT U_INSURANCESBR UNIQUE (USAPATIENTID, COMPANYNAME, GROUPID, MEMBERSHIPID) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE SBYN_COMMENT ADD CONSTRAINT U_COMMENT UNIQUE (USAPATIENTID, CODE, COMMENTDATE) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE SBYN_COMMENTSBR ADD CONSTRAINT U_COMMENTSBR UNIQUE (USAPATIENTID, CODE, COMMENTDATE) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE SBYN_AUXID ADD CONSTRAINT U_AUXID UNIQUE (USAPATIENTID, AUXIDDEF, ID) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE SBYN_AUXIDSBR ADD CONSTRAINT U_AUXIDSBR UNIQUE (USAPATIENTID, AUXIDDEF, ID) DEFERRABLE INITIALLY DEFERRED;
