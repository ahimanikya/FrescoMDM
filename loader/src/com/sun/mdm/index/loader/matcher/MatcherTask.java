 ...
 */
   ...
   private void match(BlockPosition blockPosition) throws Exception {
	...
	private static class MatchType{
		...
		/**
	 * This is like a odometer. This is used in conversion of a dataobject
	 * to list of tuples. At any given time, this points to one object instance
	 * for each child type in a root data object.
	 * Assumption: Assumes that DataObject is only two levels deep hierarchy, ie. only
	 * one level of childs. To support multiple level of child hierarchy
