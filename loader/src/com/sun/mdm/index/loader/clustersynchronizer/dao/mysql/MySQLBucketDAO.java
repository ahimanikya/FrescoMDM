...
package com.sun.mdm.index.loader.clustersynchronizer.dao.mysql;
 ...
 * 
 */
public class MySQLBucketDAO extends BaseBucketDAO  {
	
	
	protected static String bucket_insert = "insert into cluster_bucket (id , bucketName, loaderName, type,state,versionno) values (0,?,?,?,?,?)";

	protected static String bucket_select = "select id, bucketName, loaderName, type,state,versionno from cluster_bucket where state=? AND type=? limit 5";


	
	private static Logger logger = Logger.getLogger(MySQLBucketDAO.class
			.getName());
