...
public class ValidationService {
    private transient static final Logger mLogger = Logger.getLogger("com.sun.mdm.index.edm.service.configuration.ValidationService");
    ...
    public static void init() throws Exception {
        ...
        vm = new HashMap();
        cd = new CodeDescription(CONFIG_MODULE_RESOLVETYPE, "R", "Resolved Until Recalculation");
        vm.put("R", cd);
        ...
        if (sysdefs != null) {
            ...
            throw new Exception(mLocalizer.t("SRC530: Source systems are not defined in database."));
        }
        ...
        if (usercodemap != null) {
            ...
            throw new Exception (mLocalizer.t("SRC531: User codes are not defined in database."));
        }
    }
    ...
    public int getUserCodeValueCount(String module) {
        ...
        if (vm == null) {
            try {
                ...
                mLogger.severe(mLocalizer.x("SRC011: Error occurred while retrieving user codes: {0}", e.getMessage()));
                vm = null;
            }
            if (vm == null) {
                return 0;
    ...
    public PullDownListItem[] getUserCodeValueItems(String module) {
        ...
        if (vm == null) {
            try {
                ...
                mLogger.severe(mLocalizer.x("SRC012: Error occurs while retrieving user codes: ", e.getMessage()));
                vm = null;
            }
            if (vm == null) {
                return null;
    ...
    public int getValueCount(String valueListName) {
        ...
        try {
            ...
            mLogger.severe(mLocalizer.x("SRC013: Error occurs while retrieving code list: ", e.getMessage()));
            vm = null;
        }
        if (vm == null) {
            return 0;
    ...
    public PullDownListItem[] getValueItems(String valueListName) {
        ...
        if (vm == null) {
            try {
                ...
                mLogger.severe(mLocalizer.x("SRC014: Error occurs while retrieving code list: ", e.getMessage()));
                vm = null;
            }
            if (vm == null) {
                return null;
    ...
    public String getDescription(String valueListName, String code) {
        ...
        if (vm == null) {
            try {
                ...
                mLogger.severe(mLocalizer.x("SRC015: Error occurs while retrieving code list: ", e.getMessage()));
                vm = null;
            }
            if (vm == null) {
                return null;
