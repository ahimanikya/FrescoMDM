...
public class QwsController {
    ...
    private transient static final Logger mLogger = Logger.getLogger("com.sun.mdm.index.qws.control.QwsController");
    ...
    public static void init() throws Exception {
        if (mc == null) {
            try {
                ...
                mc = null;
                throw new Exception (mLocalizer.t("COM500: Cannot connect to the MasterController: {0}", getRootCause(e)));
            }
        }
        if (val == null) {
            try {
        ...
        if (rptGen == null) {
            try {
                ...
                usercode = null;
                throw new Exception (mLocalizer.t("COM503: Cannot connect to the ReportGenerator Service: {0}", getRootCause(e)));
            }
        }
    }
