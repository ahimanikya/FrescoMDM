...
public class MiFieldDef {
     ...
     * @param constrainedBy
     */
    public MiFieldDef(String fieldName, String fieldType, 
            String strMatchType,
            boolean b,
            boolean k, boolean u,
     ...
     * @param v visible
     */
    public MiFieldDef(String fieldName, String fieldType, int fieldSize, boolean r, boolean k, boolean v) {
        strFieldName = fieldName;
        strFieldType = fieldType;
        size = fieldSize;
        required = r;
