...
public class FieldConfig implements Comparable{
   ...
   // private ArrayList<SelectItem> selectOptions = new ArrayList();
    ...
    public static String toEpathStyleString(String fullName) {
        ...
        return xobjRef + MIDMObjectDef.FIELD_DELIM + fieldName;
    }
 ...
 */ 
     ...
     * Added on:  12/06/2007
     * 
     * This getter method will returns the array list of select items which 
     * will be used to populate the select options in JSF Frame work.
     * 
