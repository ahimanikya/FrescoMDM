 ...
 * @version
 */
public class FixedAttributeDef {
    /**
     * string
     */
     ...
     * @param constrainedBy
     */
    public FixedAttributeDef(String fieldName, String fieldType, 
            String strMatchType,
            boolean b,
            boolean k, boolean u,
     ...
     * @param v visible
     */
    public FixedAttributeDef(String fieldName, String fieldType, int fieldSize, boolean r, boolean k, boolean v) {
        strFieldName = fieldName;
        strFieldType = fieldType;
        size = fieldSize;
        required = r;
