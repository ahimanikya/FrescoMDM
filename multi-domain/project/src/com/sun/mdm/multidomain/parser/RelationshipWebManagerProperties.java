 ...
 * @author wee
 */
public class RelationshipWebManagerProperties {
   ...
   public static String RELATIONSHIP_WEB_MANAGER = "RelationshipWebManager";
    ...
    public static String RELATIONSHIP_JNDI = "jndi-resources";
    
    public static String NAME = "name";
    
    public static String mTAG_REL_FIELD_DISPLAY_NAME = "display-name";
    ...
    public static String mTAG_REL_FIELD_GUI_TYPE = "gui-type";
    ...
    public static String PAGE_IDENTIFIER = "identifier";
    
    public static String PAGE_TAB = "tab";
    ...
    public static String mTAG_PROPERTY_VALUE = "value";
    
    public static String mTAG_JNDI_NAME = "jndi-name";
    
    public static String mTAG_JNDI_ID = "id";
