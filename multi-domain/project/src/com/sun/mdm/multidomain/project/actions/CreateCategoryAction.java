 ...
 * @author kkao
 */
public class CreateCategoryAction extends CookieAction {
    ...
    private static final Logger mLog = Logger.getLogger(
            CreateCategoryAction.class.getName());
    ...
    public String getName() {
        return NbBundle.getMessage(CreateCategoryAction.class, "LBL_Action_Add_Category");
    }
    ...
    public void performAction(final Node[] activatedNodes) {
        try {
            RequestProcessor.getDefault().post(new Runnable() {
                public void run() {
                    try {
                        ...
                        mLog.severe(NbBundle.getMessage(CreateCategoryAction.class, "MSG_FAILED_To_Add_Category")); // NOI18N
            ...
            String msg = NbBundle.getMessage(CreateCategoryAction.class, "MSG_FAILED_To_Perform_AddCategoryAction") + ex.getMessage();
            mLog.info(msg);
