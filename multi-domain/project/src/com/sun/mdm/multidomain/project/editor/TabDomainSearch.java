        ...
        jPanelSearchResultLayout.setHorizontalGroup(
            ...
            .add(jPanelSearchResultLayout.createSequentialGroup()
                .add(jPanelSearchResultLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    .add(jPanelSearchResultLayout.createSequentialGroup()
                        .add(277, 277, 277)
                        .add(jBtnAddSearchResult, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 78, Short.MAX_VALUE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
                        .add(jBtnRemoveSearchResult, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 80, Short.MAX_VALUE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(jBtnEditSearchResult, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 78, Short.MAX_VALUE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED))
