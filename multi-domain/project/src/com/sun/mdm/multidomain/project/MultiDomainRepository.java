 ...
 */
    ...
    /*
     * Singleton instance of MultiDomainRepository
    */
    private static MultiDomainRepository repository = new MultiDomainRepository();
    private FileObject currentFolder;

    /**
      protected constructor
    */
    protected MultiDomainRepository() {
       
    }

    /**
      get the singleton instance of MultiDomainRepository
    */
    public static MultiDomainRepository getMultiDomainRepository() {
        return repository;     
    }
  ...
  */ 
    ...
    */
    ...
    Return null, if no File exists and create == false
     throws MultiDomainRepositoryException if  it can�t create a file
    */
    public FileObject getConfigurationFile(String folder, String name, boolean create) throws MultiDomainRepositoryException {
        try{
            if (folder == null) {
                return null;
            }
    ...
    throws MultiDomainRepositoryException if it can�t delete a file
    */
    public boolean deleteConfiguration(String folder, String name)  throws MultiDomainRepositoryException {
        try {
            if (folder == null) {
                return false;
            }
