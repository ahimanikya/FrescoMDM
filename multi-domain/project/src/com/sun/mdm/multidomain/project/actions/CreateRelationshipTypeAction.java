 ...
 * @author kkao
 */
public class CreateRelationshipTypeAction extends CookieAction {
    ...
    private static final Logger mLog = Logger.getLogger(
            CreateRelationshipTypeAction.class.getName());
    ...
    public CreateRelationshipTypeAction() {
    }
    ...
    public String getName() {
        return NbBundle.getMessage(CreateRelationshipTypeAction.class, "LBL_Action_Add_Relationship");
    }
    ...
    public void performAction(final Node[] activatedNodes) {
        try {
            RequestProcessor.getDefault().post(new Runnable() {
                public void run() {
                    try {
                        ...
                        mLog.severe(NbBundle.getMessage(CreateRelationshipTypeAction.class, "MSG_FAILED_To_Add_Relationship")); // NOI18N
            ...
            String msg = NbBundle.getMessage(CreateRelationshipTypeAction.class, "MSG_FAILED_To_Perform_AddRelationshipAction") + ex.getMessage();
            mLog.info(msg);
