 ...
 * @author kkao
 */
public class CreateHierarchyAction extends CookieAction {
    ...
    private static final Logger mLog = Logger.getLogger(
            CreateHierarchyAction.class.getName());
    ...
    public String getName() {
        return NbBundle.getMessage(CreateHierarchyAction.class, "LBL_Action_Add_Hierarchy");
    }
    ...
    public void performAction(final Node[] activatedNodes) {
        try {
            RequestProcessor.getDefault().post(new Runnable() {
                public void run() {
                    try {
                        ...
                        mLog.severe(NbBundle.getMessage(CreateHierarchyAction.class, "MSG_FAILED_To_Add_Hierarchy")); // NOI18N
            ...
            String msg = NbBundle.getMessage(CreateHierarchyAction.class, "MSG_FAILED_To_Perform_AddHierarchyAction") + ex.getMessage();
            mLog.info(msg);
