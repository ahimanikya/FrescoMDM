...
public final class QwsUtil {
    private transient static final Logger mLogger = Logger.getLogger("com.sun.mdm.multidomain.services.security.util.QwsUtil");
    ...
    public static Collection getValueForField(ObjectNode majorNode,
        String fieldPath, UserProfile user) throws ObjectException, ConfigException {
    ...
    public static String getFieldNameFromFieldPath(String fieldPath) {
        ...
        int index = fieldPath.lastIndexOf(MDConfigManager.FIELD_DELIM);
    ...
    public static String getObjRefFromFieldPath(String fieldPath) {
        ...
        int index = fieldPath.indexOf(MDConfigManager.FIELD_DELIM);
    ...
    public static String getLastObjRefFromFieldPath(String fieldPath) {
        ...
        String[] tokens = partialFieldPath.split("[" + MDConfigManager.FIELD_DELIM + "]");
    ...
    private static String getValueFromNode(ObjectNode targetNode,
        ...
        // testing--raymond tam
        // RESUME HERE        
//        ObjectNodeConfig objc = MDConfigManager.getInstance().getObjectNodeConfig(targetNode.pGetTag());
        ObjectNodeConfig objc = null;
...
//	}
    ...
    public static void setObjectNodeFieldValue(ObjectNode node, String field, 
        ...
        // testing--raymond tam
        // RESUME HERE        
//                ObjectNodeConfig config = MDConfigManager.getInstance()
