...
<div dojoType="dijit.layout.BorderContainer" splitter="true" style="width:100%; height:100%;padding:0px;border:0px;">
   ...
   <div dojoType="dijit.layout.ContentPane" region="center" gutters="true" minSize="50" splitter="true" style="border:0px;">
   ...
   <div dojoType="dijit.layout.ContentPane" gutters="true" region="bottom"  minSize="100"  splitter="true" style="height:300px;border:0px;">
