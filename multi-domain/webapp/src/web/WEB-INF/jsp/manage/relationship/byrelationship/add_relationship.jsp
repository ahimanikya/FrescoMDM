...
<body class="mdwm">
    <table border="0" width="100%">
       ...
       <tr>
            <td align="right"><input type="button" id="ByRelAddRelationshipButton" disabled = "true" onclick="ByRelAddRelationship()" title="<f:message key="add_text" />" value="<f:message key="add_text" />"/>
