...
public class EviewFolderNode extends DataFolder.FolderNode {
    ...
    //public EviewConfigurationFolderNode() {
    public EviewFolderNode(String displayName, DataFolder folder) {
        folder.super();
        this.folder = folder;
        this.displayName = displayName;
        this.setDisplayName(displayName);
        this.setIconBaseWithExtension("com/sun/mdm/index/project/ui/resources/eviewproFolderNode.png");
    }
