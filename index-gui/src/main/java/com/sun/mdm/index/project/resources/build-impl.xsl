  ...
  - cleanup
    ...
    INITIALIZATION SECTION 
            ...
            <target name="do-init">
                ...
                <taskdef name="generate-mdm-index-files" classname="com.sun.mdm.index.project.anttasks.EViewGeneratorTask">
                    <classpath>
    ...
    COMPILATION SECTION
            ...
            <target name="gen-mdm-index-files">
                ...
                <generate-mdm-index-files srcdir="${{src.dir}}" ejbdir= "${{ejb.dir}}" wardir="${{war.dir}}"/>
            </target>
