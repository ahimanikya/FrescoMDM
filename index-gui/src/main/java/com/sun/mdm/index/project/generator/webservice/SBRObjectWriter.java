...
class SBRObjectWriter {
     ...
     */
    public SBRObjectWriter(String path, String name) {
        try {
            mTW = new TemplateWriter("com/sun/mdm/index/project/generator/webservice/SBRObject.java.tmpl"); 
    ...
    public void write()
        ...
        try {
            ...
            = new RandomAccessFile(mPath + "/" + "SBR" + mName + ".java", "rw");
