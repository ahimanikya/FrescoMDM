 ...
 */
class ValityMefaStandardizationWriter implements GenInterface {
    private static final String VALITY_TEMPLATE_NAME = "ValityMefaStandardization.tmpl";
    /**
     * Creates an instance
     */
    public ValityMefaStandardizationWriter() {
    }
        ...
        if (fieldSettings != null) {
            ...
            if (matchTypeID != null) {
                ...
                TemplateWriter templateWriter 
                        = ConfigGenerator.getFragmentTemplateWriter(matchType, VALITY_TEMPLATE_NAME);
