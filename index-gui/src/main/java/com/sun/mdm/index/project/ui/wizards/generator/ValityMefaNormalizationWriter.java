 ...
 */
class ValityMefaNormalizationWriter implements GenInterface {
    private static final String TEMPLATE_NAME = "ValityMefaNormalization.tmpl";

    /**
     * Creates an instance
     */
    public ValityMefaNormalizationWriter() {
    }
