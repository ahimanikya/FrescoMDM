...
public class EviewMatchEngineFolderNode extends EviewFolderNode {
    ...
    public EviewMatchEngineFolderNode(String displayName, DataFolder folder) {
        super(displayName, folder);
        this.folder = folder;
        this.getCookieSet().add(new EviewMatchEngineFolderCookie(this));                
    }
    
    @Override
    public Action[] getActions( boolean context ) {
        return new Action[] {
            SystemAction.get(ImportComparatorAction.class),
            null,
