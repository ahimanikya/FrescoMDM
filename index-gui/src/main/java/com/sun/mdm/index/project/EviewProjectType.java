...
public class EviewProjectType implements AntBasedProjectType {
    public static final String TYPE = "com.sun.mdm.index.project";
    public static final String PROJECT_CONFIGURATION_NAME = "data";
    //public static final String PROJECT_CONFIGURATION_NAMESPACE = "http://www.netbeans.org/ns/j2ee-eviewproject/1";
    ...
    public Project createProject(AntProjectHelper helper) throws IOException {
        ...
        return new EviewApplication(helper);
    }
