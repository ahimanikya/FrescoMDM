 ...
 *
 */
public class EviewConfigurationDataObject extends MultiDataObject {
    //private static final long serialVersionUID = 6338889116068357652L;

    /**
     * Creates a new EviewConfigurationDataObject object.
     *
     ...
     */
    public EviewConfigurationDataObject(FileObject fObj, UniFileLoader loader)
        throws DataObjectExistsException {
        super(fObj, loader);
        getCookieSet().add(new EviewConfigurationEditSupport(this));
    ...
    @Override    protected Node createNodeDelegate() {
        return new EviewFileNode(new EviewConfigurationNode(this));
    }
