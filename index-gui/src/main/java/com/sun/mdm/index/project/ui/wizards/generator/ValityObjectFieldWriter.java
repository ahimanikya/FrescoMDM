...
/**
 * The Vality generator for the 'field' fragment for the object model configuration
 */
public class ValityObjectFieldWriter implements GenInterface {
    /**
     * ObjectField fragment type
     */
    public static final String FRAGMENT_TYPE_OBJECT_FIELD = "OBJECTFIELD";
    
    private static final String TEMPLATE_NAME = "ValityObjectField.tmpl";

    /**
     * Creates an instance
     */
    public ValityObjectFieldWriter() {
    }
