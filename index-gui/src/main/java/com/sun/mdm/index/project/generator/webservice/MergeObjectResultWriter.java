...
class MergeObjectResultWriter {
     ...
     */
    public MergeObjectResultWriter(String path, String name) {
        try {
            mTW = new TemplateWriter("com/sun/mdm/index/project/generator/webservice/MergeObjectResult.java.tmpl"); 
