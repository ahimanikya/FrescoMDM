...
/**
 * The main generator for the validation configuration
 */
public class ValidationWriter {
    /**
     * The unqualified template file name for this generator.
     */
    public static final String VALIDATION_TEMPLATE = "validation.xml.tmpl";
     ...
     */
    public ValidationWriter(String path, ConfigSettings configSettings) {
        mPath = path;
    ...
    public String generate()
        ...
        */
        ...
        java.io.InputStream is = this.getClass().getResourceAsStream(VALIDATION_TEMPLATE);

        if (is != null) {
            mTW = new TemplateWriter(is, VALIDATION_TEMPLATE);
