...
class SunEJBJarXMLWriter {
     ...
     */
    public SunEJBJarXMLWriter(String path, String name) {
        try {  
            mTW = new TemplateWriter("com/sun/mdm/index/project/generator/webservice/sun-ejb-jar.xml.tmpl"); 
    ...
    public void write()
        ...
        try {
            ...
            = new RandomAccessFile(mPath + "/sun-ejb-jar.xml", "rw");
