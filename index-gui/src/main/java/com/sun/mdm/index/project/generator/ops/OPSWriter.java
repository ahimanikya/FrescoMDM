...
public class OPSWriter {
     ...
     */
    public OPSWriter(String path, EIndexObject eo)
    ...
    public void write(NodeDef node, 
        ...
        try {
            ...
            ObjectNodeDBWriter onw 
                = new ObjectNodeDBWriter(mPath, 
                                         parent, 
                                         node, 
                                         childList);
            onw.write();
    ...
    public void write()
        ...
        if (null != relList) {
            for (int i = 0; i < relList.size(); i++) {
                ...
                nList.add(relDef.getName());
                if (relDef.getElements() != null) {
                    nList.addAll(relDef.getElements());
                }
            }
        }
        
        OPSHelperWriter opshw 
            = new OPSHelperWriter(mPath, 
                                  nList);
        opshw.write();
    }
}
