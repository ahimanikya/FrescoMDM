...
class DestinationEOWriter {
    ...
    public DestinationEOWriter(String path, String name) {
        try {  
            mTW = new TemplateWriter("com/sun/mdm/index/project/generator/webservice/DestinationEO.java.tmpl"); 
    ...
    public void write()
        ...
        try {
            ...
            = new RandomAccessFile(mPath + "\\" + "DestinationEO.java", "rw");
