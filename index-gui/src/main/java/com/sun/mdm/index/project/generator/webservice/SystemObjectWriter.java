...
class SystemObjectWriter {
     ...
     */
    public SystemObjectWriter(String path, String name) {
        try {
            mTW = new TemplateWriter("com/sun/mdm/index/project/generator/webservice/SystemObject.java.tmpl"); 
    ...
    public void write()
        ...
        try {
            ...
            = new RandomAccessFile(mPath + "/" + "System" + mName + ".java", "rw");
