...
Translate from 
    <root>
        <eview partnerLink="pl0" partnerLinkType="plt0" roleName="r0" file="f0"/> 
        ...
        <eview partnerLink="pl3" partnerLinkType="plt3" roleName="r3" file="f3"/> 
    </root>
to
    <portmaps>
...
<xsl:template match="eviewmap">
<portmaps>
    <xsl:apply-templates/>
</portmaps>
</xsl:template>

<xsl:template match="eview">
    <portmap>
