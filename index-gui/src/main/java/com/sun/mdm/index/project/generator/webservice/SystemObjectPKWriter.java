...
class SystemObjectPKWriter {
     ...
     */
    public SystemObjectPKWriter(String path, String name) {
        try {
            mTW = new TemplateWriter("com/sun/mdm/index/project/generator/webservice/SystemObjectPK.java.tmpl"); 
    ...
    public void write()
        ...
        try {
            ...
            = new RandomAccessFile(mPath + "/" + "System" + mName + "PK.java", "rw");
