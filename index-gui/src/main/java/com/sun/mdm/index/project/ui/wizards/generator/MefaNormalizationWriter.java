...
/**
 * The default generator for the 'normalization' fragment for the mefa configuration
 */
class MefaNormalizationWriter implements GenInterface {
    private static final String TEMPLATE_NAME = "MefaNormalization.tmpl";

    /**
     * Creates an instance
     */
    public MefaNormalizationWriter() {
    }
        ...
        if (fieldSettings != null) {
            ...
            if (matchTypeID != null) {
                ...
                if (templateWriter != null) {
                    ...
                    String[] fieldsToStandardize = new String[] {
                            targetQualifiedNodeName + "." + fieldName
                        };
                    ...
                    if (fieldsToStandardize != null) {
                        for (int fieldCount = 0;
                                fieldCount < fieldsToStandardize.length;
                                fieldCount++) {
